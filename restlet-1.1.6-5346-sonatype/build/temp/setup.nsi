...
!insertmacro MUI_PAGE_LICENSE ../dist/classic/restlet-1.1.6-SONATYPE-5348-V5/license.txt
...
OutFile ../dist/restlet-1.1.6-SONATYPE-5348-V5.exe
InstallDir "$PROGRAMFILES\Noelios\Restlet-1.1"
CRCCheck on
XPStyle on
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /r ../dist/classic/restlet-1.1.6-SONATYPE-5348-V5\*.*
...
Section -post SEC0001
    ...
    WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)${VERSION}" DisplayName "Noelios Restlet Engine 1.1.6-SONATYPE-5348-V5"
...
Section un.post UNSEC0001
    ...
    ${If} ${FileExists} "$INSTDIR\uninstall.log"
      ...
      ; Remove the installation directory if it is empty
       ...
       StrCmp "$INSTDIR" "$PROGRAMFILES\Noelios\Restlet-1.1" 0 +2
